...
def basicPageSetup(pageNo):
    ...
    back_img = tk.PhotoImage(file= r"D:\Facial-Recognition-for-Crime-Detection-master\Facial-Recognition-for-Crime-Detection-master\img\back.png")
...
def selectMultiImage(opt_menu, menu_var):
    ...
    if(len(path_list) < 5):
        ...
        back_img = tk.PhotoImage(file="D:/Facial-Recognition-for-Crime-Detection-master/Facial-Recognition-for-Crime-Detection-master/img/previous.png")
        next_img = tk.PhotoImage(file="D:/Facial-Recognition-for-Crime-Detection-master/Facial-Recognition-for-Crime-Detection-master/img/next.png")
...
logo = tk.PhotoImage(file = r"D:\Facial-Recognition-for-Crime-Detection-master\Facial-Recognition-for-Crime-Detection-master\img\logo2.png")
